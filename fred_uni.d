...
immutable NFC_QCN = Charset([
    Interval(0x00340,0x00341),
    Interval(0x00343,0x00344),
    Interval(0x00374,0x00374),
    Interval(0x0037e,0x0037e),
    Interval(0x00387,0x00387),
    Interval(0x00958,0x0095f),
    Interval(0x009dc,0x009dd),
    Interval(0x009df,0x009df),
    Interval(0x00a33,0x00a33),
    Interval(0x00a36,0x00a36),
    Interval(0x00a59,0x00a5b),
    Interval(0x00a5e,0x00a5e),
    Interval(0x00b5c,0x00b5d),
    Interval(0x00f43,0x00f43),
    Interval(0x00f4d,0x00f4d),
    Interval(0x00f52,0x00f52),
    Interval(0x00f57,0x00f57),
    Interval(0x00f5c,0x00f5c),
    Interval(0x00f69,0x00f69),
    Interval(0x00f73,0x00f73),
    Interval(0x00f75,0x00f76),
    Interval(0x00f78,0x00f78),
    Interval(0x00f81,0x00f81),
    Interval(0x00f93,0x00f93),
    Interval(0x00f9d,0x00f9d),
    Interval(0x00fa2,0x00fa2),
    Interval(0x00fa7,0x00fa7),
    Interval(0x00fac,0x00fac),
    Interval(0x00fb9,0x00fb9),
    Interval(0x01f71,0x01f71),
    Interval(0x01f73,0x01f73),
    Interval(0x01f75,0x01f75),
    Interval(0x01f77,0x01f77),
    Interval(0x01f79,0x01f79),
    Interval(0x01f7b,0x01f7b),
    Interval(0x01f7d,0x01f7d),
    Interval(0x01fbb,0x01fbb),
    Interval(0x01fbe,0x01fbe),
    Interval(0x01fc9,0x01fc9),
    Interval(0x01fcb,0x01fcb),
    Interval(0x01fd3,0x01fd3),
    Interval(0x01fdb,0x01fdb),
    Interval(0x01fe3,0x01fe3),
    Interval(0x01feb,0x01feb),
    Interval(0x01fee,0x01fef),
    Interval(0x01ff9,0x01ff9),
    Interval(0x01ffb,0x01ffb),
    Interval(0x01ffd,0x01ffd),
    Interval(0x02000,0x02001),
    Interval(0x02126,0x02126),
    Interval(0x0212a,0x0212b),
    Interval(0x02329,0x0232a),
    Interval(0x02adc,0x02adc),
    Interval(0x0f900,0x0fa0d),
    Interval(0x0fa10,0x0fa10),
    Interval(0x0fa12,0x0fa12),
    Interval(0x0fa15,0x0fa1e),
    Interval(0x0fa20,0x0fa20),
    Interval(0x0fa22,0x0fa22),
    Interval(0x0fa25,0x0fa26),
    Interval(0x0fa2a,0x0fa2d),
    Interval(0x0fa30,0x0fa6d),
    Interval(0x0fa70,0x0fad9),
    Interval(0x0fb1d,0x0fb1d),
    Interval(0x0fb1f,0x0fb1f),
    Interval(0x0fb2a,0x0fb36),
    Interval(0x0fb38,0x0fb3c),
    Interval(0x0fb3e,0x0fb3e),
    Interval(0x0fb40,0x0fb41),
    Interval(0x0fb43,0x0fb44),
    Interval(0x0fb46,0x0fb4e),
    Interval(0x1d15e,0x1d164),
    Interval(0x1d1bb,0x1d1c0),
    Interval(0x2f800,0x2fa1d),
]);


immutable NFC_QCM = Charset([
    Interval(0x00300,0x00304),
    Interval(0x00306,0x0030c),
    Interval(0x0030f,0x0030f),
    Interval(0x00311,0x00311),
    Interval(0x00313,0x00314),
    Interval(0x0031b,0x0031b),
    Interval(0x00323,0x00328),
    Interval(0x0032d,0x0032e),
    Interval(0x00330,0x00331),
    Interval(0x00338,0x00338),
    Interval(0x00342,0x00342),
    Interval(0x00345,0x00345),
    Interval(0x00653,0x00655),
    Interval(0x0093c,0x0093c),
    Interval(0x009be,0x009be),
    Interval(0x009d7,0x009d7),
    Interval(0x00b3e,0x00b3e),
    ...
    Interval(0x00dcf,0x00dcf),
    Interval(0x00ddf,0x00ddf),
    Interval(0x0102e,0x0102e),
    Interval(0x01161,0x01175),
    Interval(0x011a8,0x011c2),
    Interval(0x01b35,0x01b35),
    Interval(0x03099,0x0309a),
    Interval(0x110ba,0x110ba),
]);
